...
# --- guides (FR-PRP-001, FR-PRP-003, FR-PRP-004, FR-PRP-007, FR-PRP-009) -------
#
# Guide bodies intentionally stay as safe, structured plain text. The web guide
# renderer understands headings, ordered steps, and bullet points without
# turning admin-authored content into arbitrary HTML.
