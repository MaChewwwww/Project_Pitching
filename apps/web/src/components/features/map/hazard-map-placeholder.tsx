 ...
 * and mapped barangay evacuation center counts.
 */
  ...
  return (
    ...
    >
      <div className="grid lg:grid-cols-[1.4fr_1fr]">
        ...
        {/* Right Column: Official Flood Hazard Layer Legend & Infrastructure Metrics */}
          ...
          <div className="flex items-center gap-2.5 border-b border-neutral-200/80 pb-3">
            ...
            <div>
              ...
              <span className="text-[11px] font-semibold text-neutral-500">
                Official National Hazard-Map Convention
              </span>
            </div>
          </div>

          {/* Official Flood Hazard Legend Cards */}
          <div className="flex flex-col gap-2">
            <p className="text-[10px] font-extrabold uppercase tracking-wider text-neutral-500">
              Flood Risk Levels & Depth
            </p>
