...
import type { MemberOut, MemberUpdate, RegistryMemberOut } from "@/lib/api/registry-types";
...
export function RegistryMemberForm({ initial, isHead = false, protectedName = false, submitLabel = "Save Citizen", onSubmit, onCancel }: { initial?: MemberOut | RegistryMemberOut; isHead?: boolean; protectedName?: boolean; submitLabel?: string; onSubmit: (values: MemberUpdate) => Promise<void>; onCancel?: () => void }) {
