  ...
  return (
    <div className="flex flex-col gap-4">
            ...
            <div className="flex items-start justify-between gap-3">
              <div className="flex items-center gap-2">
                ...
                <div>
                  ...
                  <h3 className="text-h3 leading-tight font-extrabold text-neutral-900">
                    {active_checkin.evac_center_name}
                  </h3>
                </div>
              </div>
              <span className="inline-flex shrink-0 items-center gap-1 rounded-full bg-emerald-200/80 px-2.5 py-1 text-xs font-bold text-emerald-900">
                <CheckCircle2 className="size-3.5 text-emerald-700" /> Active Stay
              </span>
            </div>

            <div className="flex flex-wrap items-center gap-x-4 gap-y-1.5 text-xs font-medium text-neutral-700">
      ...
      {history.length > 0 ? (
        <Card>
          <CardContent className="flex flex-col gap-3 p-5">
            <div className="flex items-center gap-2 border-b border-neutral-100 pb-2.5 text-neutral-900">
            ...
            <div className="flex flex-col gap-2.5 divide-y divide-neutral-100">
              {history.map((item) => (
                ...
                >
                  ...
                  <span
                    className={`shrink-0 rounded-full px-2 py-0.5 text-[10px] font-bold ${item.checked_out_at ? "bg-neutral-100 text-neutral-600" : "bg-emerald-100 text-emerald-800"}`}
                  >
