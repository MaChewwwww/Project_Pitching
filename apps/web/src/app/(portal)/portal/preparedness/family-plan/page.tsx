              ...
              <CardContent className="p-5 sm:p-6 space-y-4">
                <div className="flex items-start gap-3 border-b border-neutral-100 pb-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-neutral-500">
                      Where should everyone assemble if flood water cuts off phone signal or your street becomes impassable?
                    </p>
                  </div>
                </div>
                ...
                <div className="space-y-1.5">
                  ...
                  <span className="text-[11px] text-neutral-400 block pt-0.5">
                    Choose a well-known, elevated location nearby that everyone knows how to walk to safely.
                  </span>
                </div>
              </CardContent>
            </Card>
              ...
              <CardContent className="p-5 sm:p-6 space-y-4">
                <div className="flex items-start gap-3 border-b border-neutral-100 pb-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-neutral-500">
                      A trusted relative or friend living outside the flood zone who can relay messages if local cell lines are congested.
                    </p>
                  </div>
                </div>
                ...
                <div className="space-y-1.5">
                  ...
                  />
                  <span className="text-[11px] text-neutral-400 block pt-0.5">
                    During heavy typhoons, SMS to outside provinces or cities often succeeds when local cellular towers are congested.
                  </span>
                </div>
              </CardContent>
            </Card>
              ...
              <CardContent className="p-5 sm:p-6 space-y-4">
                <div className="flex items-start gap-3 border-b border-neutral-100 pb-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-neutral-500">
                      Critical information emergency responders or relatives should know about your household.
                    </p>
                  </div>
                </div>
                ...
                <div className="space-y-1.5">
                  ...
                  />
                  <span className="text-[11px] text-neutral-400 block pt-0.5">
                    Include daily prescription maintenance, mobility devices, infant supplies, and pet evacuation plans.
                  </span>
                </div>
              </CardContent>
            </Card>
              ...
              <CardContent className="p-5 sm:p-6 space-y-4">
                ...
                <div className="space-y-3 text-xs text-neutral-600 leading-relaxed">
                  <div className="flex items-start gap-2.5">
                    ...
                    <p>
                      <strong className="text-neutral-900">Pre-pack Go-Bags:</strong> Keep bags near the exit when Orange or Red alert is raised.
                    </p>
                  </div>
                  <div className="flex items-start gap-2.5">
                    <span className="grid size-5 shrink-0 place-items-center rounded-full bg-emerald-100 text-[11px] font-black text-emerald-800">
                    ...
                    <p>
                      <strong className="text-neutral-900">Utility Shut-Off:</strong> Switch off the main breaker and turn off the LPG regulator valve.
                    </p>
                  </div>
                  <div className="flex items-start gap-2.5">
                    <span className="grid size-5 shrink-0 place-items-center rounded-full bg-emerald-100 text-[11px] font-black text-emerald-800">
                    ...
                    <p>
                      <strong className="text-neutral-900">Notify Out-of-Area Contact:</strong> Send a single SMS with your destination before departing.
                    </p>
                  </div>
                  <div className="flex items-start gap-2.5">
                    <span className="grid size-5 shrink-0 place-items-center rounded-full bg-emerald-100 text-[11px] font-black text-emerald-800">
                    ...
                    <p>
                      <strong className="text-neutral-900">Check In at Evacuation Center:</strong> Register all members with the barangay desk upon arrival.
                    </p>
                  </div>
                </div>
              </CardContent>
            ...
            <Card className="border-emerald-200/70 bg-gradient-to-br from-emerald-50/50 to-teal-50/30 shadow-2xs">
              <CardContent className="p-5 space-y-3">
                ...
                <p className="text-xs text-neutral-600 leading-relaxed">
                  If any family member is trapped or requires assisted transport during an active typhoon, use the portal&apos;s <strong>Safety Check-in</strong> or submit a direct rescue ticket.
                </p>
              </CardContent>
            </Card>
          </div>
