...
const WATERWAY_OPTIONS = [
  {
    ...
    description: "Within 1 km of a river, creek, or active drainage channel",
  ...
  },
  {
    ...
    description: "More than 6 km away from rivers or major floodways",
    ...
    <div className="space-y-6 sm:space-y-8">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 sm:gap-8 items-start">
        ...
        >
          ...
          {/* Card 2: Waterway Proximity Assessment (Interactive Radio Cards from Onboarding) */}
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="mt-0.5 text-xs text-neutral-500 italic">
                      Distance to nearest river, creek, or flood channel
                    </p>
                  </div>
                </div>
                    ...
                    {WATERWAY_OPTIONS.map((opt) => {
                      ...
                      return (
                        <label
                          key={opt.value}
                          className={cn(
                            "flex cursor-pointer items-start gap-3 rounded-2xl border p-3.5 transition-all duration-150",
                            opt.cardTone,
                            selected
                              ? opt.selectedTone
          ...
          <div className="flex items-center justify-end gap-3 pt-2">
            <Button
              ...
              className="h-10 rounded-full border-neutral-300 bg-white px-5 text-xs font-bold text-neutral-700 hover:bg-neutral-50 shadow-2xs"
            >
              Cancel
            </Button>
            <Button
        ...
        {/* ── Right Column: Registered Members Management (5 cols) ── */}
