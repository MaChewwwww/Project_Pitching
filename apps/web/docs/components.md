...
- `AnnouncementDetailView` presents announcement detail pages in a space-maximizing 2-column layout (`lg:grid-cols-12`): main article content on the left (`lg:col-span-8`) and a Recent Notices sidebar on the right (`lg:col-span-4`) with compact article previews and an emergency hotline callout.
