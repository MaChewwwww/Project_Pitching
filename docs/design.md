...
| `WeatherWatchWorkspace`          | Console tabs for cached weather/river overview, manual field readings, and admin-only threshold review. Keeps the public data panels and human-issued alert boundary in one operational surface                                                                                                                                                         |
...
| ---------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------- |
| **`cards`** _(default below `md`)_ | Each row renders as a stacked card: identity at top, key fields as label/value pairs, badges in a row, actions as a full-width button row | User Management, household registry, rescue queue — anything a BHW or admin browses on a phone |
