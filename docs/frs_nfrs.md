...
| `NFR` | Non-Functional Requirements (Cross-Cutting) |  88   |      0      |        10         |        7        |        65         |       6        |       0       |      **19%**      | Validation evidence still pending |

_Overall Active Completion: **135 / 256 active requirements (53%)** implemented, in progress, or in review. The denominator excludes 27 retired FRs and 6 deferred privacy NFRs. This is the full roadmap metric, **not** the pitch-demo completion metric. The full pitch demo remains in progress until the Resident Portal and About/team work are complete._
