...
### 2.1 Demo-release audit — August 17, 2026

`ce66a7e` established the Public Information Site and Barangay Portal baseline. The subsequent
resident-portal, seed-story, loading-state, and performance work is part of the current demo
release. This is a scope and design record, not evidence that an FR satisfies the Definition of
Done; status remains below `✅` until peer review and the required verification are recorded.
...
> **Aug 16, 2026 activities and preparedness pass.** Reworked the public activity and guide reading flows, their admin workspaces, and their supporting API contracts. `FR-ACT-001`–`003`, `FR-ACT-010`–`012`, `FR-PRP-001`, `FR-PRP-003`, `FR-PRP-007`, and `FR-PUB-005` remain `◐` pending responsive browser verification and peer review.

> **Aug 17, 2026 demo-release documentation audit.** Reconciled the shipped Resident Portal,
> research-backed flood-response seed story, portal loading/motion system, current staging profile,
> and route contracts with the root and local docs. The functional Public, Resident, and Barangay
> Admin demo flows are recorded as complete; only final About/platform and team source material
> remains pending. Individual FR/NFR statuses are intentionally unchanged pending Definition of Done
> evidence and peer review.

> **Aug 21, 2026 preparedness content pass.** Replaced the five demo guide bodies with the
> project-supplied bilingual flood, earthquake, fire, typhoon, and emergency nutrition-bag
> articles. Added the shared public/admin article renderer and a data refresh migration. `FR-PRP-001`,
> `FR-PRP-003`, `FR-PRP-004`, `FR-PRP-007`, and `FR-PRP-009` remain `◐` pending responsive browser
