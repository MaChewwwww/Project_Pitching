...
| Admin console  | Registry, emergency response, weather, alerts, facilities, activities, guides, FAQs, and donation-drive CRUD are reachable. | Navigation hierarchy, responsive behavior, workflow clarity, and the three article-authoring experiences need a later design pass. Current breadth is not evidence that every linked FR meets Definition of Done.                    |
